...
M.config = function()
  ...
  keyset("n", "gf", "<Plug>(coc-codeaction-cursor)", { silent = true })
  ...
  -- Add extensions
  vim.fn["coc#add_extension"]("coc-pyright")
  vim.fn["coc#add_extension"]("coc-prettier")
  vim.fn["coc#add_extension"]("coc-eslint")
